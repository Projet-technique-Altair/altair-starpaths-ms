...
impl StarpathFeedbackService {
    ...
    pub async fn ensure_schema(&self) -> Result<(), AppError> {
        sqlx::query(
            r#"
            CREATE TABLE IF NOT EXISTS starpath_feedbacks (
                feedback_id UUID PRIMARY KEY,
                starpath_id UUID NOT NULL REFERENCES starpaths(starpath_id) ON DELETE CASCADE,
                ...
                creator_seen_at TIMESTAMPTZ NULL,
                creator_resolved_at TIMESTAMPTZ NULL
            );
            "#,
        )
        .execute(&self.db)
        ...
        sqlx::query(
            r#"
            CREATE TABLE IF NOT EXISTS starpath_feedback_votes (
                feedback_id UUID NOT NULL REFERENCES starpath_feedbacks(feedback_id) ON DELETE CASCADE,
                user_id UUID NOT NULL,
        ...
        sqlx::query(
            r#"
            CREATE TABLE IF NOT EXISTS starpath_feedback_replies (
                reply_id UUID PRIMARY KEY,
                feedback_id UUID NOT NULL UNIQUE REFERENCES starpath_feedbacks(feedback_id) ON DELETE CASCADE,
                starpath_id UUID NOT NULL REFERENCES starpaths(starpath_id) ON DELETE CASCADE,
        ...
        sqlx::query(
            r#"
            CREATE INDEX IF NOT EXISTS idx_starpath_feedbacks_starpath_created_at
            ON starpath_feedbacks (starpath_id, created_at DESC);
            "#,
        )
        .execute(&self.db)
        .await
        ...
        sqlx::query(
            r#"
            CREATE INDEX IF NOT EXISTS idx_starpath_feedback_votes_feedback_id
            ON starpath_feedback_votes (feedback_id);
            "#,
        )
        .execute(&self.db)
        .await
        ...
        sqlx::query(
            r#"
            CREATE INDEX IF NOT EXISTS idx_starpath_feedback_replies_starpath_created_at
            ON starpath_feedback_replies (starpath_id, created_at DESC);
            "#,
        )
        .execute(&self.db)
        .await
